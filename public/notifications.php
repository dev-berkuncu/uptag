                ...
                <?php else: ?>
                    <div class="notifications-list">
                        <?php foreach ($notifications as $notif): ?>
                            <a href="<?php echo BASE_URL; ?>/<?php echo $notif['checkin_id'] ? 'feed?post=' . $notif['checkin_id'] : 'profile?id=' . $notif['from_user_id']; ?>" class="notification-card <?php echo $notif['is_read'] ? '' : 'unread'; ?>">
