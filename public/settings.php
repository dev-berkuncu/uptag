...
// Resim yükleme fonksiyonu (ImageUploader wrapper)
function uploadImage($file, $type, $userId)
{
    ...
    // Avatar için küçük boyut, banner için büyük boyut
    $options = [
        'maxSize' => $maxSize,
        'outputFormat' => 'webp',
        'quality' => 85
    ...
    $result = $uploader->upload($file, $folder, $options);
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-with-prefix">
                                ...
                                <input type="text" id="tag" name="tag" value="<?php echo escape($user['tag'] ?? ''); ?>"
                                    placeholder="kullanici_adi" pattern="[a-zA-Z0-9_]{3,30}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" value="<?php echo escape($user['email']); ?>"
                                required>
                        </div>
