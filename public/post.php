...
<head>
    ...
    <meta name="description"
        content="<?php echo escape($post['username']); ?> - <?php echo escape(substr($post['note'] ?? $post['venue_name'], 0, 100)); ?>">
            ...
            <div class="post-detail-container">
                ...
                <article class="tweet post-detail-card">
                    <div class="tweet-inner">
                        <a href="<?php echo BASE_URL; ?>/profile?id=<?php echo $post['user_id']; ?>"
                            class="tweet-avatar">
                        ...
                        <div class="tweet-content">
                            ...
                            <a href="<?php echo BASE_URL; ?>/venue-detail?id=<?php echo $post['venue_id']; ?>"
                                class="tweet-venue">
                            ...
                            <?php if (isLoggedIn()): ?>
                                <div class="tweet-actions">
                                    ...
                                    <button class="tweet-action action-repost <?php echo $userReposted ? 'active' : ''; ?>"
                                        data-checkin-id="<?php echo $post['id']; ?>">
                                        <span class="tweet-action-icon">🔄</span>
                                        <span class="action-count"><?php echo $post['repost_count']; ?></span>
                                    </button>
                                    <button class="tweet-action action-like <?php echo $userLiked ? 'active' : ''; ?>"
                                        data-checkin-id="<?php echo $post['id']; ?>">
                                        <span
                                            class="tweet-action-icon like-icon"><?php echo $userLiked ? '❤️' : '🤍'; ?></span>
                        ...
                        <?php else: ?>
                            <?php foreach ($comments as $comment): ?>
                                <div class="comment-item">
                                    <a href="<?php echo BASE_URL; ?>/profile?id=<?php echo $comment['user_id']; ?>"
                                        class="comment-avatar">
                                        <?php if (!empty($comment['avatar'])): ?>
                                            <img src="<?php echo BASE_URL; ?>/uploads/avatars/<?php echo escape($comment['avatar']); ?>"
                                                alt="">
                                        <?php else: ?>
                                    ...
                                    <div class="comment-content">
                                        <div class="comment-header">
                                            <a href="<?php echo BASE_URL; ?>/profile?id=<?php echo $comment['user_id']; ?>"
                                                class="comment-username"><?php echo escape($comment['username']); ?></a>
                                            <span
                                                class="comment-time"><?php echo formatDate($comment['created_at'], true); ?></span>
                                        </div>
