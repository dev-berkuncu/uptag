...
<head>
    ...
    <meta name="description" content="<?php echo escape($venueData['name']); ?> - Sociaera'da check-in yap ve puan kazan!">
    ...
    <footer class="footer">
        <div class="footer-content">
            <div class="footer-about">
                <h3>Sociaera</h3>
                <p>Sociaera, sosyal keşif ve check-in platformudur. Favori mekanlarınızde anlarınızı paylaşın.</p>
            </div>
        </div>
